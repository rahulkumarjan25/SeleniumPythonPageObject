...
class BasePage:
    ...
    def type(self, locator, value):
        ...
        log.logger.info("Typing in an Element: " + str(locator) + "Value Enterd as :" + str(value))
    ...
    def moveToElement(self, locator):
        ...
        log.logger.info("Move to Element: " + str(locator))

    # def getTitle(self, locator):
    #     if str(locator).endswith("_XPATH"):
    #         title = self.driver.find_element_by_xpath(configReader.readConfig(("locators", locator))).text
    #     elif str(locator).endswith("_CSS"):
    #         title = self.driver.find_element_by_css_selector(
    #             configReader.readConfig(("locators", locator))).text
    #     elif str(locator).endswith("_ID"):
    #         title = self.driver.find_element_by_id(configReader.readConfig(("locators", locator))).text
    #
    #     return title
